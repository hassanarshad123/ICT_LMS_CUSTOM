...
/// password reset link.
///
/// Uses the public Dio provider (no auth required) since the user is not
/// logged in. Follows the same ConsumerStatefulWidget + Form + SnackBar
/// patterns as LoginScreen.
