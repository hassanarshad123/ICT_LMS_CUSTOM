                  ...
                  <div key={cls.id} className="bg-white rounded-2xl p-4 sm:p-6 card-shadow hover:card-shadow-hover transition-all duration-200">
                    <div className="flex flex-col sm:flex-row items-start justify-between gap-4">
                      <div className="flex items-start gap-4">
                        <div className={`w-12 h-12 sm:w-14 sm:h-14 ${cls.status === 'live' ? 'bg-red-100' : 'bg-accent'} rounded-2xl flex items-center justify-center flex-shrink-0`}>
                          <Video size={24} className={cls.status === 'live' ? 'text-red-600' : 'text-primary'} />
                        </div>
                        <div>
