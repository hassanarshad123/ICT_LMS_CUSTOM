          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
            <Link href="/student/courses">
              <div className="bg-white rounded-2xl p-5 sm:p-6 card-shadow hover:card-shadow-hover transition-all duration-200 cursor-pointer group">
                ...
                <p className="text-2xl sm:text-3xl font-bold text-[#1A1A1A]">{courses.length}</p>
            ...
            <Link href="/student/zoom">
              <div className="bg-white rounded-2xl p-5 sm:p-6 card-shadow hover:card-shadow-hover transition-all duration-200 cursor-pointer group">
                ...
                <p className="text-2xl sm:text-3xl font-bold text-[#1A1A1A]">{upcomingClasses.length}</p>
            ...
            <Link href="/student/jobs">
              <div className="bg-white rounded-2xl p-5 sm:p-6 card-shadow hover:card-shadow-hover transition-all duration-200 cursor-pointer group">
                ...
                <p className="text-2xl sm:text-3xl font-bold text-[#1A1A1A]">{jobsData?.total ?? 0}</p>
                    ...
                    <div key={cls.id} className="flex items-center justify-between p-4 rounded-xl bg-gray-50">
                      ...
                      {cls.zoomMeetingUrl && (
                        <a
                          ...
                          className="px-3 py-1.5 bg-[#1A1A1A] text-white rounded-lg text-xs font-medium hover:bg-[#333] transition-colors"
                        >
                          Join
                        </a>
                      )}
